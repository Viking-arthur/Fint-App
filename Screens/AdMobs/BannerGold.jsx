      ...
      <View style={styles.container}>
        ...
        <View style={styles.menuContainer}>
          <View style={styles.menuSection}>
            ...
            />
            <Text style={styles.menuLabel}>{'Gold Package:'}</Text>
            <Text style={styles.menuLabel}>{'the user is provided with the features and payment option, which are exclusive only for Gold packege users '}
            </Text>
