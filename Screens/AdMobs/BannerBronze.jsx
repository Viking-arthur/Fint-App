      ...
      <View style={styles.container}>
        ...
        <View style={styles.menuContainer}>
          <View style={styles.menuSection}>
            ...
            />
            <Text style={styles.menuLabel}>{'Bronze Package:'}</Text>
            <Text style={styles.menuLabel}>{'the user is provided with the features and payment option, which are exclusive only for bronze packege users '}
            </Text>
