...
const HiringProfile2 = () => {
  const [skills] = useState(['React Native', 'JavaScript', 'TypeScript', 'Node.js', 'Python']); // Sample skills
  ...
  return (
    <Background>
      ...
      <View style={styles.profileSection}>
        ...
        <Text style={styles.profileName}>Vishwas</Text>

        {/* UPI ID Section */}
        <View style={styles.upiBox}>
          <Text style={styles.upiText}>Tech lead</Text>
        </View>
